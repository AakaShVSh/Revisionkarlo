...
//   // Pick a subject → fetch its data → go to question list
//   const setsub = (subject) => {
//     setSubject(subject); // triggers fetch in context
...
//             <Text color="#2d3748" fontSize="24px" fontWeight="700">
//               Loading Quiz Portal
//             </Text>
...
//       bg: "linear-gradient(135deg,#2c64ff,#2658e6)",
//       shadow: "rgba(44,100,255,.3)",
//     },
//     {
//       label: "English",
//       key: "english",
//       icon: <FaBook size={32} color="white" />,
//       bg: "linear-gradient(135deg,#66afdd,#5a9dc9)",
//       shadow: "rgba(102,175,221,.3)",
//     },
//     {
//       label: "General Studies",
//       key: "gs",
//       icon: <FaGlobe size={32} color="white" />,
//       bg: "linear-gradient(135deg,#ff782c,#e66a28)",
//       shadow: "rgba(255,120,44,.3)",
//     },
//     {
//       label: "Reasoning",
//       key: "reasoning",
//       icon: <FaBrain size={32} color="white" />,
//       bg: "linear-gradient(135deg,#48bb78,#41a968)",
//       shadow: "rgba(72,187,120,.3)",
//     },
//     {
//       label: "Maths",
//       key: "math",
//       icon: <FaCalculator size={32} color="white" />,
//       bg: "linear-gradient(135deg,#41d8d5,#39c2bf)",
//       shadow: "rgba(65,216,213,.3)",
//     },
//   ];
...
//           {[
//             {
//               icon: <FaYoutube size={36} color="white" />,
//               label: "YouTube",
//               bg: "linear-gradient(135deg,#FF0000,#cc0000)",
//               shadow: "rgba(255,0,0,.3)",
//             },
//             {
//               icon: <FaTelegram size={36} color="white" />,
//               label: "Telegram",
//               bg: "linear-gradient(135deg,#29b6f6,#1e88e5)",
//               shadow: "rgba(41,182,246,.3)",
//             },
//             {
//               icon: <FaInstagram size={36} color="white" />,
//               label: "Instagram",
//               bg: "linear-gradient(135deg,#E4405F,#c13584)",
//               shadow: "rgba(228,64,95,.3)",
//             },
//             {
//               icon: <FaFacebook size={36} color="white" />,
//               label: "Facebook",
//               bg: "linear-gradient(135deg,#1877F2,#0d65d9)",
//               shadow: "rgba(24,119,242,.3)",
//             },
//             {
//               icon: <FaWhatsapp size={36} color="white" />,
//               label: "WhatsApp",
//               bg: "linear-gradient(135deg,#25D366,#1ebe57)",
//               shadow: "rgba(37,211,102,.3)",
//               onClick: () =>
//                 window.open(
...
//                 ),
//             },
//           ].map(({ icon, label, bg, shadow, onClick }) => (
//             <Box
//               key={label}
//               onClick={onClick}
//               textAlign="center"
//               cursor="pointer"
//               _hover={{ transform: "translateY(-8px) scale(1.05)" }}
...
//           gap={{ base: 4, md: 5, lg: 6 }}
//         >
//           {subjectCards.map(({ label, key, icon, bg, shadow }) => (
//             <Box
//               key={key}
//               onClick={() => setsub(key)}
//               cursor="pointer"
...
//                 {icon}
//               </Box>
//               <Text fontSize={{ base: "14px", md: "15px" }} fontWeight="600">
//                 {label}
//               </Text>
//             </Box>
//           ))}
...
//               _hover={{
//                 transform: "translateY(-8px)",
//                 boxShadow: "0 12px 24px rgba(92,76,227,.3)",
//               }}
//               transition="all .3s cubic-bezier(.4,0,.2,1)"
//               bg="linear-gradient(135deg,#5c4ce3,#5244cc)"
//               color="white"
//               borderRadius={{ base: "12px", md: "16px" }}
//               boxShadow="0 4px 12px rgba(0,0,0,.1)"
//               p={{ base: 4, md: 5, lg: 6 }}
